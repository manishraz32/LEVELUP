...
public class questions {
    ...
    public static void unfold_(ListNode head) {
        if (head == null || head.next == null)
            return;
    ...
    public static ListNode mergeKLists_(ListNode[] lists) {
        if (lists.length == 0)
            return null;
    ...
    public static ListNode reverse_(ListNode head) {
        if (head == null || head.next == null)
            return head;
    ...
    public static ListNode removeDuplicates_(ListNode head) {
        if (head == null || head.next == null)
            return head;
